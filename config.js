...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || '*𝐉𝐚𝐫𝐢𝐛𝐞𝐫*;𝐑𝐞𝐛𝐢𝐫𝐚𝐣;https://cdn.ironman.my.id/i/f6arip.jpeg',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;𝓠𝓾𝓮𝓮𝓷 𝓑𝓲𝓷𝓭𝔂𝓪;https://cdn.ironman.my.id/i/tyr13b.jpeg',

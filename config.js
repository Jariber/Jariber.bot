...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || '*𝐉𝐚𝐫𝐢𝐛𝐞𝐫*;𝐑𝐞𝐛𝐢𝐫𝐚𝐣;https://cdn.ironman.my.id/i/yt26vt.jpeg',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "*𝐉𝐚𝐫𝐢𝐛𝐞𝐫*", "body": "ᴀᴡᴇꜱᴏᴍᴇ ❦", "thumbnailUrl": "https://cdn.ironman.my.id/i/195mv0.jpeg", "renderLargerThumbnail": true, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Vincenzo675/Bindya-V2", "showAdAttribution": true}`,
  KOYEB_API: process.env.KOYEB_API,
  BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
  TGTOKEN: "bot891038791:AAHWB1dQd-vi0IbH2NjKYUk-hqQ8rQuzPD4",
  API: 'https://api-loki-ser-1o2h.onrender.com/',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '*𝐉𝐚𝐫𝐢𝐛𝐞𝐫*',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;*𝐉𝐚𝐫𝐢𝐛𝐞𝐫*;https://cdn.ironman.my.id/i/yt26vt.jpeg',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '918787487369',
  STARTING_MSG: toBool(process.env.STARTING_MSG) || true,
  LOG_MSG: toBool(process.env.LOG_MSG) || true,
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || '*𝐉𝐚𝐫𝐢𝐛𝐞𝐫*;𝐑𝐞𝐛𝐢𝐫𝐚𝐣;https://cdn.ironman.my.id/i/nrki8w.jpeg',
